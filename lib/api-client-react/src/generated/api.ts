...
export const getDiagnoseMutationOptions = <TError = ErrorType<ApiError>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DiagnoseMutationError = ErrorType<ApiError>

    /**
 * @summary Diagnose crop or livestock issue
 */
export const useDiagnose = <TError = ErrorType<ApiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof diagnose>>, TError,{data: BodyType<DiagnoseInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
